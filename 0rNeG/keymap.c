...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_EQUAL,       KC_DLR,         KC_HASH,        KC_AT,          KC_EXLM,        KC_LPRN,        TT(7),                                          KC_TRANSPARENT, KC_RPRN,        KC_AMPR,        KC_ASTR,        KC_CIRC,        KC_PERC,        KC_MINUS,       
    KC_DELETE,      KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           TT(4),                                          KC_TRANSPARENT, KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLS,        
    ...
    LT(2, KC_ENTER),KC_BSPC,        KC_TRANSPARENT,                 KC_TRANSPARENT, LT(3, KC_TAB),  KC_SPACE
  ),
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_PAGE_UP,     KC_PGDN,        KC_END,         KC_HOME,        KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_AT,          KC_LABK,        KC_RABK,        KC_EXLM,        KC_EQUAL,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_DQUO,        KC_AMPR,        KC_PIPE,        KC_QUOTE,       KC_CIRC,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_DLR,         KC_GRAVE,       KC_LPRN,        KC_RPRN,        KC_BSLS,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_LCBR,        KC_RCBR,        KC_LBRC,        KC_RBRC,        KC_HASH,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_ASTR,        KC_MINUS,       KC_PLUS,        KC_SLASH,                                       KC_PERC,        KC_UNDS,        KC_TILD,        KC_QUES,        KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
  ...
  [6] = LAYOUT_moonlander(
    ...
    MU_TOGG,        KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_UP,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN3,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    MU_NEXT,        KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN1,     KC_MS_BTN2,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
